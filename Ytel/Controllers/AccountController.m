                ...
                completionBlock:(CompletedPostViewAccount) onCompleted
{
    ...
    if (input.date == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'date' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/accounts/viewaccount.{ResponseType}"];
