                ...
                completionBlock:(CompletedPostMassReleaseNumber) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/incomingphone/massreleasenumber.{ResponseType}"];
                ...
                completionBlock:(CompletedPostTransferNumber) onCompleted
{
    ...
    if (input.phonenumber == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'phonenumber' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.fromaccountsid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'fromaccountsid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.toaccountsid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'toaccountsid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/incomingphone/transferphonenumbers.{ResponseType}"];
                ...
                completionBlock:(CompletedPostMassUpdateNumber) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/incomingphone/massupdatenumber.{ResponseType}"];
                ...
                completionBlock:(CompletedPostGetDIDScoreNumber) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/incomingphone/getdidscore.{ResponseType}"];
                ...
                completionBlock:(CompletedPostBulkBuyNumber) onCompleted
{
    ...
    if (input.areaCode == nil)
        ...
        _validationError = [[APIError alloc] initWithReason: @"The property 'quantity' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/incomingphone/bulkbuy.{ResponseType}"];
