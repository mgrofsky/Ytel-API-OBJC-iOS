                ...
                completionBlock:(CompletedPostViewKeyword) onCompleted
{
    ...
    if (input.keywordid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'keywordid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/keyword/view.{ResponseType}"];
                ...
                completionBlock:(CompletedPostListKeyword) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/keyword/lists.{ResponseType}"];
                ...
                completionBlock:(CompletedPostViewAssignement) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/shortcode/viewshortcode.{ResponseType}"];
                ...
                completionBlock:(CompletedPostListAssignment) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/shortcode/listshortcode.{ResponseType}"];
                ...
                completionBlock:(CompletedPostUpdateAssignment) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/shortcode/updateshortcode.{ResponseType}"];
    ...
    [_parameters addEntriesFromDictionary: @{
        ...
        @"CallbackMethod": [HttpActionEnumHelper stringFromHttpActionEnum: (enum HttpActionEnum) input.callbackMethod withDefault: [NSNull null]],
        @"FallbackUrl": (nil != input.fallbackUrl) ? input.fallbackUrl : [NSNull null],
        @"FallbackUrlMethod": [HttpActionEnumHelper stringFromHttpActionEnum: (enum HttpActionEnum) input.fallbackUrlMethod withDefault: [NSNull null]]
    }];
