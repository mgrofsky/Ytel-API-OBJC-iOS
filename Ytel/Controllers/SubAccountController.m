                ...
                completionBlock:(CompletedPostSuspendSubAccount) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/user/subaccountactivation.{ResponseType}"];
                ...
                completionBlock:(CompletedPostCreateSubAccount) onCompleted
{
    ...
    if (input.firstName == nil)
        ...
        _validationError = [[APIError alloc] initWithReason: @"The property 'email' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.friendlyName == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'friendlyName' in the input object cannot be nil."
                                                    andContext:nil];
