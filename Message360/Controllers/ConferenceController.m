                ...
                completionBlock:(CompletedPostCreateConference) onCompleted
{
    ...
    if (input.from == nil)
        ...
        _validationError = [[APIError alloc] initWithReason: @"The property 'url' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.recordCallbackUrl == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'recordCallbackUrl' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.responseType == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'responseType' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/createConference.{ResponseType}"];
    ...
    [_parameters addEntriesFromDictionary: @{
        @"From": input.from,
        @"To": input.to,
        @"Method": [HttpActionEnumHelper stringFromHttpActionEnum: (enum HttpActionEnum) input.method withDefault: @"POST"],
        ...
        @"SchdeuleTime": (nil != input.schdeuleTime) ? input.schdeuleTime : [NSNull null],
                ...
                completionBlock:(CompletedPostHangupParticipant) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/hangupparticipant.{ResponseType}"];
                ...
                completionBlock:(CompletedPostPlayConferenceAudio) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/conferences/playaudio.{ResponseType}"];
    ...
    [_parameters addEntriesFromDictionary: @{
        @"ConferenceSid": input.conferenceSid,
        @"ParticipantSid": input.participantSid,
        @"AudioUrl": [AudioFormatEnumHelper stringFromAudioFormatEnum: (enum AudioFormatEnum) input.audioUrl withDefault: [NSNull null]]
    }];
