...
//
#import "WebRTCController.h"

@implementation WebRTCController
                ...
                completionBlock:(CompletedPostCheckFunds) onCompleted
{
    ...
    if (input.accountSid == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'accountSid' in the input object cannot be nil."
                                                    andContext:nil];
    else if (input.authToken == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'authToken' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    [_queryBuilder appendString: @"/webrtc/checkFunds.json"];
                ...
                completionBlock:(CompletedPostCreateToken) onCompleted
{
    ...
    if (input.accountSid == nil)
        ...
        _validationError = [[APIError alloc] initWithReason: @"The property 'username' in the input object cannot be nil."
                                                    andContext:nil];
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/webrtc/agentLogin.json"];
